...
namespace spitalkDLL
{
    public class SapiTalk
    {
        ...
        public SpMemoryStream MakeSpStream(string text, bool asyncFlag = false)
        {
        ...
        public MemoryStream MakeStream(string text, bool asyncFlag = false) {
            
            MemoryStream ms = new MemoryStream(MakeSpStream(text,asyncFlag).GetData());
